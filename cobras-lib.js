...
(function (global) {
  ...
  const STRINGS = {
    ...
    ar: {
      ...
      'lang.toggle': 'English',
      'lang.label': 'اللغة',
      'footer.brand': 'كوبرات سيس الجادة',
      'footer.tag': 'فريق سباق كهربائي طلابي · سابيس الجادة · الشارقة',
      'footer.rights': 'حقوق النشر 2026 كوبرات سيس الجادة',
      'chat.open': 'CarGPT',
      ...
      'analytics.notice': 'زيارة مجهولة محلية (صديقة للخصوصية).',
      'game.kicker': 'برنامج تجربة آركيد',
      ...
      'game.finishCopy': 'النتيجة {score} · {mode}. الأفضل {best}. سابق مجدداً.',
      'game.shareCopied': 'تم نسخ النتيجة — الصقها في أي مكان',
      'home.eyebrow': 'EVGP · سابيس الجادة · الشارقة',
      'home.title1': 'بُنِيَ ليضرب.',
      'home.title2': 'صُمِّمَ ليتسابق.',
      ...
      'package.download': 'تنزيل PDF الرعاية',
      ...
      'home.machKicker': 'لوحة البناء الحالية',
      ...
      'home.prove': 'أثبت',
      'home.proveBody': 'اختبر الأداء، شخص الأعطال، وحسّن السيارة لـ EVGP.',
