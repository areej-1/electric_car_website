...
(function (global) {
  const COMMON = {
    ...
    "01 / The car": "01 / السيارة",
    "Published weight · re-weigh pending": "الوزن المنشور · بانتظار إعادة الوزن",
    "Published benchmark · run date pending": "المعيار المنشور · تاريخ الاختبار قيد التأكيد",
    "The specification sheet was last updated in May 2026. Measurement dates and test conditions have not been published.": "آخر تحديث لورقة المواصفات كان في مايو 2026. لم تُنشر تواريخ القياس وظروف الاختبار بعد.",
    "Assembly footage from the team archive.": "لقطة من فيديو التجميع في أرشيف الفريق.",
    ...
    "Message the team on Instagram": "راسل الفريق عبر إنستغرام",
    "Download package PDF": "نزّل باقة الرعاية بصيغة PDF",
    "The team has not published an approved funding target, donation total, or partner list. The remaining funding need cannot be calculated until figures are approved.": "لم ينشر الفريق هدفًا تمويليًا معتمدًا أو إجمالي التبرعات أو قائمة الشركاء. لا يمكن حساب التمويل المتبقي حتى اعتماد الأرقام.",
    "Start with the team.": "ابدأ بالتواصل مع الفريق.",
    "Message the Cobras social account for routing to the right school contact for equipment, race, or learning partnerships.": "راسل حساب كوبرا على التواصل الاجتماعي للوصول إلى جهة الاتصال المناسبة في المدرسة لشراكات المعدات أو السباق أو التعلّم.",
    "Role descriptions are shared by discipline. Individual assignments await team confirmation.": "توضح الأوصاف مهام كل تخصص. المهام الفردية بانتظار تأكيد الفريق.",
    "Portrait pending": "الصورة قيد الإعداد",
    'Our Team': 'فريقنا',
