...
(function (global) {
  ...
  const PAGES = {
    ...
    'about.html': {
      ...
      'Who We Are': 'من نحن', 'The SIS Al Jada Cobras are a student-led electric race team at SABIS® Al Jada. Students in Grades 10 and 11 design, build, and test a real race car—combining engineering, safety, media, and teamwork under one black-and-red brand.': 'فريق كوبرا سيس الجادة هو فريق سباق كهربائي يقوده طلاب سابيس® الجادة. يصمّم طلاب الصفين العاشر والحادي عشر سيارة سباق حقيقية ويبنونها ويختبرونها، جامعِين الهندسة والسلامة والإعلام والعمل الجماعي تحت هوية واحدة بالأسود والأحمر.',
    ...
    'sponsors.html': {
      ...
      'Your support helps Grades 10–11 students turn ideas into a real electric race car—and gives your organization a visible role in hands-on STEM education.': 'يساعد دعمكم طلاب الصفين العاشر والحادي عشر على تحويل الأفكار إلى سيارة سباق كهربائية حقيقية، ويمنح مؤسستكم دورًا بارزًا في دعم تعليم العلوم والتقنية والهندسة والرياضيات بالتجربة العملية.',
